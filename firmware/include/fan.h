...
// Re-evaluate fan duty from the latest CO2 reading and, if the target moved,
// start an LEDC hardware fade to it over FAN_DUTY_GLIDE_MS. Call whenever a
// fresh SEN66 reading lands; co2==0 (no reading yet) is a no-op. No-op if
